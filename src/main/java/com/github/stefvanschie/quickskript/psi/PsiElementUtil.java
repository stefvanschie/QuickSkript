...
public class PsiElementUtil {
     ...
     */
    @NotNull
    private static final List<PsiElementFactory<?>> FACTORIES = new ArrayList<>();
    ...
    public static PsiElement<?> tryParseText(@NotNull String input) {
        ...
        for (PsiElementFactory<?> factory : FACTORIES) {
    ...
    /**
     * Registers the specified {@link PsiElementFactory}.
     *
     * @param elementFactory the {@link PsiElementFactory} of the {@link PsiElement} being registered
     * @since 0.1.0
     */
    private static void registerElement(@NotNull PsiElementFactory<? extends PsiElement<?>> elementFactory) {
		Validate.isTrue(FACTORIES.add(elementFactory), "The specified PsiElementFactory has already been registered.");
    }
