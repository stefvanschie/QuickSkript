...
public class PsiSineFunction extends PsiElement<Double> {
     ...
     * @since 0.1.0
     */
    protected PsiSineFunction(PsiElement<?> parameter, int lineNumber) {
        super(lineNumber);
    ...
    public static class Factory implements PsiElementFactory<PsiSineFunction> {
        ...
        @Nullable
        @Override
        public PsiSineFunction tryParse(@NotNull String text, int lineNumber) {
         ...
         */
        @NotNull
        protected PsiSineFunction create(PsiElement<?> element, int lineNumber) {
