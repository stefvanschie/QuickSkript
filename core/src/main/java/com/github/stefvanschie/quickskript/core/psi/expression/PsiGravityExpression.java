 ...
 * @since 0.1.0
 */
public class PsiGravityExpression extends PsiElement<Boolean> implements Resettable, Settable {

    /**
     * The entity to get the gravity for
     */
    @NotNull
     ...
     * @since 0.1.0
     */
    protected PsiGravityExpression(@NotNull PsiElement<?> entity, int lineNumber) {
        super(lineNumber);
    ...
    /**
     * A factory for creating {@link PsiGravityExpression}s
     *
     * @since 0.1.0
     */
    public static class Factory implements PsiElementFactory {
        ...
        public PsiGravityExpression create(@NotNull PsiElement<?> entity, int lineNumber) {
            return new PsiGravityExpression(entity, lineNumber);
        }
    }
}
