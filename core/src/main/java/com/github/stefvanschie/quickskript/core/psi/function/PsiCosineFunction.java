...
public class PsiCosineFunction extends PsiElement<Double> {
    ...
    public static class Factory implements PsiElementFactory {
         ...
         */
        @NotNull
        private final Pattern pattern = Pattern.compile("cos\\((?<parameter>[\\s\\S]+)\\)");
        ...
        @Contract(pure = true)
        @Fallback
        public PsiCosineFunction tryParse(@NotNull SkriptLoader skriptLoader, @NotNull String text, int lineNumber) {
