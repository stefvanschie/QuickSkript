...
public class StandaloneSkriptLoader extends SkriptLoader {
    ...
    public void registerDefaultElements() {
        ...
        //conditions
        registerElement(new PsiBlockIsPersistentCondition.Factory());
        ...
        registerElement(new PsiChunkCoordinateIsLoadedCondition.Factory());
        registerElement(new PsiChunkLocationIsLoadedCondition.Factory());
        registerElement(new PsiContainsItemTypeCondition.Factory());
        ...
        registerElement(new PsiEntityDataIsRidingCondition.Factory());
        registerElement(new PsiEntityIsInBubbleColumnCondition.Factory());
        registerElement(new PsiEntityIsIncendiaryCondition.Factory());
        registerElement(new PsiEntityIsInLavaCondition.Factory());
        registerElement(new PsiEntityIsInRainCondition.Factory());
        registerElement(new PsiEntityIsInvulnerableCondition.Factory());
        registerElement(new PsiEntityIsInWaterCondition.Factory());
        registerElement(new PsiEntityIsOfTypeCondition.Factory());
        registerElement(new PsiEntityIsPersistentCondition.Factory());
        ...
        registerElement(new PsiIsAdultCondition.Factory());
        registerElement(new PsiIsAliveCondition.Factory());
        registerElement(new PsiIsAlphanumericCondition.Factory());
        registerElement(new PsiIsAnchorSpawnCondition.Factory());
        registerElement(new PsiIsBabyCondition.Factory());
        ...
        registerElement(new PsiIsChargedCondition.Factory());
        ...
        registerElement(new PsiIsFrozenCondition.Factory());
        registerElement(new PsiIsFuelCondition.Factory());
        registerElement(new PsiIsGlidingCondition.Factory());
        registerElement(new PsiIsHandRaisedCondition.Factory());
        registerElement(new PsiIsHoldingCondition.Factory());
        registerElement(new PsiIsInfiniteCondition.Factory());
        registerElement(new PsiIsInLoveCondition.Factory());
        registerElement(new PsiIsInteractableCondition.Factory());
        registerElement(new PsiIsInventoryEmptyCondition.Factory());
        registerElement(new PsiIsInvisibleCondition.Factory());
        registerElement(new PsiIsItemStackEmptyCondition.Factory());
        registerElement(new PsiIsJumpingCondition.Factory());
        registerElement(new PsiIsLeashedCondition.Factory());
        registerElement(new PsiIsLootableCondition.Factory());
        registerElement(new PsiIsNormalizedCondition.Factory());
        registerElement(new PsiIsOccludingCondition.Factory());
        registerElement(new PsiIsOnGroundCondition.Factory());
        registerElement(new PsiIsOnlineCondition.Factory());
        registerElement(new PsiIsOperatorCondition.Factory());
        registerElement(new PsiIsPassableCondition.Factory());
        registerElement(new PsiIsPathfindingCondition.Factory());
        registerElement(new PsiIsPlayingDeadCondition.Factory());
        registerElement(new PsiIsPluginEnabledCondition.Factory());
        registerElement(new PsiIsPoisonedCondition.Factory());
        registerElement(new PsiIsPreferredToolCondition.Factory());
        registerElement(new PsiIsPressingKeyCondition.Factory());
        registerElement(new PsiIsResponsiveCondition.Factory());
        registerElement(new PsiIsRidingCondition.Factory());
        ...
        registerElement(new PsiWorldIsLoadedCondition.Factory());
        ...
        registerElement(new PsiAffectedEntitiesExpression.Factory());
        ...
        registerElement(new PsiEventBlockExpression.Factory());
        ...
        registerElement(new PsiFishingHookExpression.Factory());
        ...
        registerElement(new PsiHotbarSlotExpression.Factory());
        ...
        registerElement(new PsiInitiatorInventoryExpression.Factory());
