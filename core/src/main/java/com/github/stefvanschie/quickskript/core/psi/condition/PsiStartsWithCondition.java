...
public class PsiStartsWithCondition extends PsiElement<Boolean> {
    ...
    protected Boolean executeImpl(@Nullable SkriptRunEnvironment environment, @Nullable Context context) {
        ...
        return positive == text.startsWith(prefix.execute(environment, context, String.class));
    }
    ...
    public static class Factory implements PsiElementFactory {
        ...
        @NotNull
        @Contract(pure = true)
        @Pattern("%texts% start[s] with %text%")
        ...
        @NotNull
        @Contract(pure = true)
        @Pattern("%texts% (doesn't|does not|do not|don't) start with %text%")
