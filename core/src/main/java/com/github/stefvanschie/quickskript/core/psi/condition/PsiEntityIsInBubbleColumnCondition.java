...
public class PsiEntityIsInBubbleColumnCondition extends PsiElement<Boolean> {
    ...
    public static class Factory implements PsiElementFactory {
        ...
        /**
         * The pattern for matching positive {@link PsiEntityIsInBubbleColumnCondition}s
         */
        @NotNull
        private final SkriptPattern positivePattern = SkriptPattern.parse(
            "%entities% (is|are) in [a] bubble[ ]column"
        );

        /**
         * The pattern for matching negative {@link PsiEntityIsInBubbleColumnCondition}s
         */
        @NotNull
        private final SkriptPattern negativePattern = SkriptPattern.parse(
            "%entities% (isn't|is not|aren't|are not) in [a] bubble[ ]column"
        );
