...
import com.github.stefvanschie.quickskript.spigot.psi.literal.PsiMoneyLiteralImpl;
import com.github.stefvanschie.quickskript.spigot.psi.literal.PsiPlayerLiteralImpl;
import com.github.stefvanschie.quickskript.spigot.skript.util.ExecutionTarget;
import com.github.stefvanschie.quickskript.spigot.util.event.ExperienceOrbSpawnEvent;
import com.github.stefvanschie.quickskript.spigot.util.event.QuickSkriptPostEnableEvent;
import com.github.stefvanschie.quickskript.spigot.util.event.ServerTickEvent;
import com.github.stefvanschie.quickskript.spigot.util.event.WorldTimeChangeEvent;
import com.github.stefvanschie.quickskript.spigot.util.event.script.ScriptLoadEvent;
import com.github.stefvanschie.quickskript.spigot.util.event.script.ScriptUnloadEvent;
import com.github.stefvanschie.quickskript.spigot.util.registry.BukkitEnchantmentRegistry;
...
import com.github.stefvanschie.quickskript.spigot.psi.condition.*;
import com.github.stefvanschie.quickskript.spigot.psi.expression.*;
import com.github.stefvanschie.quickskript.spigot.util.CommandMapWrapper;
import com.github.stefvanschie.quickskript.spigot.util.ItemComparisonUtil;
import com.github.stefvanschie.quickskript.spigot.util.ResourcePackStatusUtil;
import com.github.stefvanschie.quickskript.spigot.util.TreeTypeUtil;
import org.bukkit.*;
 ...
 * @since 0.1.0
 */
public class SpigotSkriptLoader extends SkriptLoader {
     ...
     * @since 0.1.0
     */
    public SpigotSkriptLoader(@NotNull SkriptRunEnvironment environment) {
    ...
    public void registerDefaultEvents() {
        ...
        registerEvent(new SimpleEventProxyFactory()
            ...
            .registerEvent(ServerListPingEvent.class, "[on] server [list] ping")
