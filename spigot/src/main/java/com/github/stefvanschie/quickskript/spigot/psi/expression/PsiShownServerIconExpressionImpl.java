...
public class PsiShownServerIconExpressionImpl extends PsiShownServerIconExpression {
    ...
    protected CachedServerIcon executeImpl(@Nullable SkriptRunEnvironment environment, @Nullable Context context) {
        throw new ExecutionException("The shown server icon cannot be retrieved on Spigot", lineNumber);
    }
    ...
    public void reset(@Nullable SkriptRunEnvironment environment, @Nullable Context context) {
        ...
        ((ServerListPingEvent) event).setServerIcon(Bukkit.getServerIcon());
    }
    ...
    public void set(@Nullable SkriptRunEnvironment environment, @Nullable Context context, @NotNull PsiElement<?> object) {
        ...
        ((ServerListPingEvent) event).setServerIcon(object.execute(environment, context, CachedServerIcon.class));
    }
