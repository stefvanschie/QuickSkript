...
public class ItemComparisonUtil {
    ...
    static {
        ...
        POTION_MAPPING.put(PotionType.JUMP, "leaping");
        POTION_MAPPING.put(PotionType.FIRE_RESISTANCE, "fire_resistance");
        POTION_MAPPING.put(PotionType.SPEED, "swiftness");
        ...
        POTION_MAPPING.put(PotionType.INSTANT_HEAL, "healing");
        POTION_MAPPING.put(PotionType.INSTANT_DAMAGE, "harming");
        POTION_MAPPING.put(PotionType.POISON, "poison");
        POTION_MAPPING.put(PotionType.REGEN, "regeneration");
