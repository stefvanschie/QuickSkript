...
public class EnchantmentTypeUtil {
    ...
    static {
        MAPPINGS.put(Enchantment.Type.AQUA_AFFINITY, org.bukkit.enchantments.Enchantment.AQUA_AFFINITY);
        MAPPINGS.put(Enchantment.Type.BANE_OF_ARTHROPODS, org.bukkit.enchantments.Enchantment.BANE_OF_ARTHROPODS);
        MAPPINGS.put(Enchantment.Type.BLAST_PROTECTION, org.bukkit.enchantments.Enchantment.BLAST_PROTECTION);
        ...
        MAPPINGS.put(Enchantment.Type.EFFICIENCY, org.bukkit.enchantments.Enchantment.EFFICIENCY);
        MAPPINGS.put(Enchantment.Type.FEATHER_FALLING, org.bukkit.enchantments.Enchantment.FEATHER_FALLING);
        MAPPINGS.put(Enchantment.Type.FIRE_ASPECT, org.bukkit.enchantments.Enchantment.FIRE_ASPECT);
        MAPPINGS.put(Enchantment.Type.FIRE_PROTECTION, org.bukkit.enchantments.Enchantment.FIRE_PROTECTION);
        MAPPINGS.put(Enchantment.Type.FLAME, org.bukkit.enchantments.Enchantment.FLAME);
        MAPPINGS.put(Enchantment.Type.FORTUNE, org.bukkit.enchantments.Enchantment.FORTUNE);
        ...
        MAPPINGS.put(Enchantment.Type.INFINITY, org.bukkit.enchantments.Enchantment.INFINITY);
        MAPPINGS.put(Enchantment.Type.KNOCKBACK, org.bukkit.enchantments.Enchantment.KNOCKBACK);
        MAPPINGS.put(Enchantment.Type.LOOTING, org.bukkit.enchantments.Enchantment.LOOTING);
        MAPPINGS.put(Enchantment.Type.LOYALTY, org.bukkit.enchantments.Enchantment.LOYALTY);
        MAPPINGS.put(Enchantment.Type.LUCK_OF_THE_SEA, org.bukkit.enchantments.Enchantment.LUCK_OF_THE_SEA);
        ...
        MAPPINGS.put(Enchantment.Type.POWER, org.bukkit.enchantments.Enchantment.POWER);
        MAPPINGS.put(Enchantment.Type.PROTECTION, org.bukkit.enchantments.Enchantment.PROTECTION);
        MAPPINGS.put(Enchantment.Type.PROJECTILE_PROTECTION, org.bukkit.enchantments.Enchantment.PROJECTILE_PROTECTION);
        MAPPINGS.put(Enchantment.Type.PUNCH, org.bukkit.enchantments.Enchantment.PUNCH);
        MAPPINGS.put(Enchantment.Type.QUICK_CHARGE, org.bukkit.enchantments.Enchantment.QUICK_CHARGE);
        MAPPINGS.put(Enchantment.Type.RESPIRATION, org.bukkit.enchantments.Enchantment.RESPIRATION);
        MAPPINGS.put(Enchantment.Type.RIPTIDE, org.bukkit.enchantments.Enchantment.RIPTIDE);
        MAPPINGS.put(Enchantment.Type.SHARPNESS, org.bukkit.enchantments.Enchantment.SHARPNESS);
        MAPPINGS.put(Enchantment.Type.SILK_TOUCH, org.bukkit.enchantments.Enchantment.SILK_TOUCH);
        MAPPINGS.put(Enchantment.Type.SMITE, org.bukkit.enchantments.Enchantment.SMITE);
        ...
        MAPPINGS.put(Enchantment.Type.UNBREAKING, org.bukkit.enchantments.Enchantment.UNBREAKING);
    }
}