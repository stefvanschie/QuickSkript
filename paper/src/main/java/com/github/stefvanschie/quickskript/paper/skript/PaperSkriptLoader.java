...
import com.github.stefvanschie.quickskript.paper.event.SimpleEventProxyFactory;
import com.github.stefvanschie.quickskript.paper.psi.condition.*;
import com.github.stefvanschie.quickskript.paper.psi.effect.*;
import com.github.stefvanschie.quickskript.paper.psi.entitydata.PsiBeeEntityDataImpl;
import com.github.stefvanschie.quickskript.paper.psi.expression.*;
import com.github.stefvanschie.quickskript.paper.psi.function.PsiLocationFunctionImpl;
import com.github.stefvanschie.quickskript.paper.psi.function.PsiVectorFunctionImpl;
import com.github.stefvanschie.quickskript.paper.psi.function.PsiWorldFunctionImpl;
import com.github.stefvanschie.quickskript.paper.psi.literal.PsiMoneyLiteralImpl;
import com.github.stefvanschie.quickskript.paper.psi.literal.PsiPlayerLiteralImpl;
import com.github.stefvanschie.quickskript.paper.skript.util.ExecutionTarget;
import com.github.stefvanschie.quickskript.paper.util.*;
 ...
 * @since 0.1.0
 */
public class PaperSkriptLoader extends SkriptLoader {
    ...
    public void registerDefaultElements() {
        ...
        registerElement(new PsiPlayerInfoEffectImpl.Factory());
        ...
        registerElement(new PsiEntityIsPersistentConditionImpl.Factory());
        ...
        registerElement(new PsiExplosionIsIncendiaryConditionImpl.Factory());
        registerElement(new PsiGameModeIsInvulnerableCondition.Factory());
        registerElement(new PsiHasAIConditionImpl.Factory());
        registerElement(new PsiHasChatFilteringConditionImpl.Factory());
        ...
        registerElement(new PsiIsBlockIndirectlyRedstonePoweredConditionImpl.Factory());
        registerElement(new PsiIsBlockingConditionImpl.Factory());
        registerElement(new PsiIsBurningConditionImpl.Factory());
        registerElement(new PsiIsChargedConditionImpl.Factory());
        registerElement(new PsiIsClimbingConditionImpl.Factory());
        ...
        registerElement(new PsiIsFireResistantConditionImpl.Factory());
        ...
        registerElement(new PsiIsFrozenConditionImpl.Factory());
        registerElement(new PsiIsFuelConditionImpl.Factory());
        registerElement(new PsiIsGlidingConditionImpl.Factory());
        registerElement(new PsiIsHandRaisedConditionImpl.Factory());
        registerElement(new PsiIsHoldingConditionImpl.Factory());
        registerElement(new PsiIsInfiniteCondition.Factory());
        registerElement(new PsiIsInLoveConditionImpl.Factory());
        registerElement(new PsiIsInteractableConditionImpl.Factory());
        registerElement(new PsiIsInventoryEmptyConditionImpl.Factory());
        registerElement(new PsiIsInvisibleConditionImpl.Factory());
        registerElement(new PsiIsItemStackEmptyCondition.Factory());
        ...
        registerElement(new PsiIsNormalizedConditionImpl.Factory());
        registerElement(new PsiIsOccludingConditionImpl.Factory());
        registerElement(new PsiIsOnGroundConditionImpl.Factory());
        registerElement(new PsiIsOnlineConditionImpl.Factory());
        registerElement(new PsiIsOperatorConditionImpl.Factory());
        registerElement(new PsiIsPassableConditionImpl.Factory());
        registerElement(new PsiIsPathfindingConditionImpl.Factory());
        registerElement(new PsiIsPlayingDeadConditionImpl.Factory());
        registerElement(new PsiIsPluginEnabledConditionImpl.Factory());
        registerElement(new PsiIsPoisonedConditionImpl.Factory());
        registerElement(new PsiIsPreferredToolConditionImpl.Factory());
        registerElement(new PsiIsPressingKeyConditionImpl.Factory());
        registerElement(new PsiIsResponsiveConditionImpl.Factory());
        registerElement(new PsiIsRidingConditionImpl.Factory());
        registerElement(new PsiIsSleepingConditionImpl.Factory());
        registerElement(new PsiIsSlotEmptyCondition.Factory());
        ...
        registerElement(new PsiIsTextEmptyCondition.Factory());
        registerElement(new PsiItemStackIsOfTypeCondition.Factory());
        registerElement(new PsiScriptIsLoadedConditionImpl.Factory());
        registerElement(new PsiStartsWithCondition.Factory());
        registerElement(new PsiWorldIsLoadedConditionImpl.Factory());
        ...
        registerElement(new PsiEventBlockExpressionImpl.Factory());
        ...
        registerElement(new PsiHiddenPlayersExpressionImpl.Factory());
        registerElement(new PsiHotbarSlotExpressionImpl.Factory());
        registerElement(new PsiHorizontalDirectionExpression.Factory());
        registerElement(new PsiHoverListExpressionImpl.Factory());
        ...
        registerElement(new PsiPingExpressionImpl.Factory());
        ...
        registerElement(new PsiProtocolVersionExpressionImpl.Factory());
        ...
        registerElement(new PsiTPSExpressionImpl.Factory());
        registerElement(new PsiUnixTimestampExpression.Factory());
        registerElement(new PsiVehicleExpressionImpl.Factory());
        registerElement(new PsiVersionStringExpressionImpl.Factory());
    ...
    public void registerDefaultEvents() {
        ...
        registerEvent(new SimpleEventProxyFactory()
            ...
            .registerEvent(PlayerArmorChangeEvent.class, "[on] [player] armor change[d]")
            ...
            .registerEvent(PlayerJumpEvent.class, "[on] [player] jump[ing]")
            ...
            .registerEvent(ProjectileCollideEvent.class, "[on] projectile collide")
        ...
        registerEvent(new ComplexEventProxyFactory(this)
            ...
            .registerEvent(EntityMoveEvent.class, "[on] %entity type% (move|walk|step)", matches -> {
                for (SkriptMatchResult match : matches) {
                    PsiElement<?>[] elements = tryParseAllTypes(match);
            ...
            .registerEvent(PlayerStartSpectatingEntityEvent.class, "[on] [player] (swap|switch) spectating [(of|from) %*entity types%]",
                matches -> {
                    for (SkriptMatchResult match : matches) {
                        PsiElement<?>[] elements = tryParseAllTypes(match);
            ...
            .registerEvent(PlayerStartSpectatingEntityEvent.class, "[on] [player] start spectating [of %*entity types%]",
                matches -> {
                    for (SkriptMatchResult match : matches) {
                        PsiElement<?>[] elements = tryParseAllTypes(match);
            ...
            .registerEvent(PlayerStopSpectatingEntityEvent.class, "[on] [player] stop spectating [(of|from) %*entity types%]",
                matches -> {
                    for (SkriptMatchResult match : matches) {
                        PsiElement<?>[] elements = tryParseAllTypes(match);
